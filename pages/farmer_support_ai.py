...
from utils.Farmer_support import initialize_gemini_client, query_gemini_farm_assistant
...
""", unsafe_allow_html=True)
def main():
    st.title("Farmer Support - AI Agricultural Advisor")

    client = initialize_gemini_client()

    user_question = st.text_area("Ask your farming-related question:")
